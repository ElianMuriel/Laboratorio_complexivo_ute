      ...
      <AppBar position="static">
        <Toolbar>
          <Typography variant="h6" sx={{ flexGrow: 1 }}>
            Laboratorio Muriel Complexivo
          </Typography>

          <Stack direction="row" spacing={1} sx={{ flexWrap: "wrap" }}>
            <Button color="inherit" component={Link} to="/">Home</Button>
            <Button color="inherit" component={Link} to="/acerca">Acerca de</Button>
            <Button color="inherit" component={Link} to="/ordenes">Listado de Órdenes</Button>
            <Button color="inherit" component={Link} to="/login">Iniciar sesión</Button>
            <Button color="inherit" component={Link} to="/admin">Administrador</Button>
          </Stack>
        </Toolbar>
      </AppBar>
